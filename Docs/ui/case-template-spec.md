...
3.  Color Palette:
    ...
    • Row 1 (Horizontal, gap 16): Primary Color _ + Secondary Color _ + Background Color _ (3× Form/Input)
    • Row 2 (Horizontal, gap 16): on Primary Color _ + on Secondary Color _ + on Background Color _ (3× Form/Input)
    • + Add image (Add Button instance)
    — Dark Scheme (Frame, 802×258, VERTICAL gap=16, pad=20):
    • Row 1 (Horizontal, gap 16): Primary Color Dark _ + Secondary Color Dark _ + Background Color Dark _ (3× Form/Input)
    • Row 2 (Horizontal, gap 16): on Primary Color Dark _ + on Secondary Color Dark _ + on Background Color Dark _ (3× Form/Input)
    • + Add image (Add Button instance)

4.  Typography:
    — «Typography» (label text)
    — Row (Horizontal, gap 16):
    • Display / Heading Font _ (Form/Input)
    • Body / Text Font _ (Form/Input)
