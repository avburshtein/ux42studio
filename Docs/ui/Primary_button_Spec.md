...
> bg-primary + мягкая тень 0/4/8/15% → hover: opacity-90 + тень 0/8/16/20%
> (transition box-shadow+opacity 150ms); active-состояний нет.
> Актуализация 2026-09-05 (27): геометрия тени заменена на «парящую»
> FullStory-style (offset X=0, тень стелется под кнопкой) — была
> 2/2/4/10% → 4/4/12/20%.
