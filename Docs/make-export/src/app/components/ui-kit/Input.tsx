...
const inputVariants = cva(
  'w-full font-["Inter:Regular",sans-serif] text-[16px] transition-colors duration-300 border focus:outline-none focus:ring-2 focus:ring-[rgba(11,110,79,0.3)]',
  {
    variants: {
      variant: {
      ...
      size: {
        sm: 'px-[24px] py-[12px] text-[14px] rounded-[48px]',
        md: 'px-[32px] py-[16px] text-[16px] rounded-[48px]',
        lg: 'px-[40px] py-[20px] text-[18px] rounded-[48px]',
      },
    },
    defaultVariants: {
      variant: 'default',
