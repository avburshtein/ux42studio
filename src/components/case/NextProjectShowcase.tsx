        ...
        >
            ...
            {nextProject && (
                <Link
                    ...
                    className='group flex w-full items-center gap-4 rounded-2xl bg-background p-6 shadow-card transition-colors hover:bg-surface-container sm:gap-6 sm:p-8 lg:p-10'
                >
